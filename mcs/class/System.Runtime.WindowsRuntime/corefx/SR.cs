...
partial class SR
{
	public const string Argument_BufferIndexExceedsCapacity = "The specified buffer index is not within the buffer capacity.";
	...
	public const string Argument_InsufficientBufferCapacity = "The specified buffer capacity is not sufficient to hold data of the specified length.";
	public const string Argument_InsufficientSpaceInSourceBuffer = "The specified source buffer does not contain the specified number of elements starting at the specified offset.";
	public const string Argument_InsufficientSpaceInTargetBuffer = "The specified destination buffer is not large enough to hold the specified number of bytes starting at the specified offset.";
	...
	public const string Argument_RelativePathMayNotBeWhitespaceOnly = "The specified relative path may not consist of whitespace only";
	public const string Argument_StreamPositionBeyondEOS = "The specified stream position is beyond the end of the stream.";
	...
	public const string ArgumentOutOfRange_WinRtAdapterBufferSizeMayNotBeNegative = "The buffer size for a Windows Runtime stream adapter may not be negative. Use a positive buffer size or 0 to disable buffering.";
	...
	public const string NotSupported_CannotConvertNotReadableToInputStream = "Cannot use the specified Stream as a Windows Runtime IInputStream because this Stream is not readable.";
	public const string NotSupported_CannotConvertNotSeekableToRandomAccessStream = "Cannot use the specified Stream as a Windows Runtime IRandomAccessStream because this Stream does not support seeking.";
	public const string NotSupported_CannotConvertNotWritableToOutputStream = "Cannot use the specified Stream as a Windows Runtime IOutputStream because this Stream is not writable.";
	...
	public const string UnauthorizedAccess_InternalBuffer = "MemoryStream's internal buffer cannot be accessed.";
	public const string NotSupported_Inheritable = "Inheritable is not a supported option.";
	public const string NotSupported_Encrypted = "Encrypted is not a supported option.";
