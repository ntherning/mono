...
if(NOT SYSTEM_MONO_EXE)
  get_filename_component(SYSTEM_MONO_EXE "${MCS_PATH}" DIRECTORY)
  set(SYSTEM_MONO_EXE "${SYSTEM_MONO_EXE}/mono")
  if(WIN32)
    set(SYSTEM_MONO_EXE "${SYSTEM_MONO_EXE}.exe")
  endif()
  set(SYSTEM_MONO_EXE "${SYSTEM_MONO_EXE}" CACHE INTERNAL "")
  message(STATUS "Using system mono executable ${SYSTEM_MONO_EXE}")
endif()
