...
if(CMAKE_HOST_WIN32)
	...
	file(APPEND ${FILE} "SET MONO_PATH=${MP}\n")
	file(APPEND ${FILE} "SET MONO_CFG_DIR=${MCD}\n")
	file(APPEND ${FILE} "\"${ME}\" --config \"${MCD}\\mono\\config\" ${EXE} %*\n")
elseif(CYGWIN)
	...
	file(APPEND ${FILE} "export MONO_PATH='${MP}'\n")
	file(APPEND ${FILE} "export MONO_CFG_DIR='${MCD}'\n")
	file(APPEND ${FILE} "'${ME}' --config '${MCD}\\mono\\config' ${EXE} \"$@\"\n")
